...
public interface UserGroupRepository extends CrudRepository<UserGroup, UserGroupPK> {
    @Query("select userGroup from UserGroup  userGroup where userGroup.userGroupPK.user.id=(:userId) and userGroup.userGroupPK.group.id=(:groupId)")
    ...
    @Query("select userGroupPK.group from UserGroup userGroup where  userGroup.userGroupPK.group.groupId=(:userId)")
    Iterable<Group> getGroupsByUserId(@Param("userId") long id);

    @Query("select userGroup from UserGroup userGroup where  userGroup.userGroupPK.group.groupId=(:userId)")
