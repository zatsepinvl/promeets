...
public class AimController {
    ...
    @RequestMapping(value = "/meet_aims", method = RequestMethod.GET)
    @ResponseBody
    public List getAims() {
        return (List) aimRepository.findAll();
    }

    @RequestMapping(value = "/meet_aims/{id}", method = RequestMethod.GET)
    @ResponseBody
    public MeetAim getMeetById(@PathVariable("id") long id) {
        return aimRepository.findOne(id);
    }

    @RequestMapping(value = "/meet_aims", method = RequestMethod.POST)
    @ResponseBody
    public MeetAim createMeet(@RequestBody MeetAim aim) {
        return aimRepository.save(aim);
    }

    @RequestMapping(value = "/meet_aims/{id}", method = RequestMethod.PUT)
    ...
    @RequestMapping(value = "/meet_aims/{id}", method = RequestMethod.DELETE)
