...
"undefined" != typeof exports && (exports.fabric = fabric), "undefined" != typeof document && "undefined" != typeof window ? (fabric.document = document, fabric.window = window, window.fabric = fabric) : (fabric.document = require("jsdom").jsdom("<!DOCTYPE html><html><head></head><body></body></html>"), fabric.document.createWindow ? fabric.window = fabric.document.createWindow() : fabric.window = fabric.document.parentWindow), fabric.isTouchSupported = "ontouchstart" in fabric.document.documentElement, fabric.isLikelyNode = "undefined" != typeof Buffer && "undefined" == typeof window, fabric.SHARED_ATTRIBUTES = ["display", "transform", "fill", "fill-opacity", "fill-rule", "opacity", "stroke", "stroke-dasharray", "stroke-linecap", "stroke-linejoin", "stroke-miterlimit", "stroke-opacity", "stroke-width", "id"], fabric.DPI = 96, fabric.reNum = "(?:[-+]?(?:\\d+|\\d*\\.\\d+)(?:e[-+]?\\d+)?)", fabric.devicePixelRatio = fabric.window.devicePixelRatio || fabric.window.webkitDevicePixelRatio || fabric.window.mozDevicePixelRatio || 1, function () {
    function t(t, e) {
    ...
    var e = Math.sqrt, i = Math.atan2, r = Math.atan, n = Math.pow, s = Math.PI / 180;
    fabric.util = {
        removeFromArray: function (t, e) {
            ...
            t.subtractEquals(e);
            var r = Math.sin(i), n = Math.cos(i), s = t.x * n - t.y * r, o = t.x * r + t.y * n;
            ...
            var h = s - r, c = o - n, l = e(h * h + c * c), u = i(c, h), f = a.length, g = 0, d = !0;
            for (t.save(), t.translate(r, n), t.moveTo(0, 0), t.rotate(u), r = 0; l > r;)r += a[g++ % f], r > l && (r = l), t[d ? "lineTo" : "moveTo"](r, 0), d = !d;
            t.restore()
            ...
            var i = r(t[0] / t[1]), o = n(t[0]) + n(t[1]), a = e(o), h = (t[0] * t[3] - t[2] * t[1]) / a, c = r((t[0] * t[2] + t[1] * t[3]) / o);
            return {angle: i / s, scaleX: a, scaleY: h, skewX: c / s, skewY: 0}
    ...
    function t(t, r, s, o, h, c, l) {
        ...
        if (n[u])return n[u];
        var f = Math.PI, g = l * f / 180, d = Math.sin(g), p = Math.cos(g), v = 0, b = 0;
        s = Math.abs(s), o = Math.abs(o);
        var m = -p * t * .5 - d * r * .5, y = -p * r * .5 + d * t * .5, _ = s * s, x = o * o, S = y * y, C = m * m, w = _ * x - _ * S - x * C, O = 0;
        if (0 > w) {
            var T = Math.sqrt(1 - w / (_ * x));
            s *= T, o *= T
        } else O = (h === c ? -1 : 1) * Math.sqrt(w / (_ * S + x * C));
        var k = O * s * y / o, j = -O * o * m / s, A = p * k - d * j + .5 * t, P = d * k + p * j + .5 * r, M = i(1, 0, (m - k) / s, (y - j) / o), L = i((m - k) / s, (y - j) / o, (-m - k) / s, (-y - j) / o);
        0 === c && L > 0 ? L -= 2 * f : 1 === c && 0 > L && (L += 2 * f);
        for (var D = Math.ceil(Math.abs(L / f * 2)), I = [], E = L / D, F = 8 / 3 * Math.sin(E / 4) * Math.sin(E / 4) / Math.sin(E / 2), B = M + E, R = 0; D > R; R++)I[R] = e(M, B, p, d, s, o, A, P, F, v, b), v = I[R][4], b = I[R][5], M = B, B += E;
        return n[u] = I, I
    }
    ...
    function e(t, e, i, r, n, o, h, c, l, u, f) {
        ...
        if (s[g])return s[g];
        var d = Math.cos(t), p = Math.sin(t), v = Math.cos(e), b = Math.sin(e), m = i * n * v - r * o * b + h, y = r * n * v + i * o * b + c, _ = u + l * (-i * n * p - r * o * d), x = f + l * (-r * n * p + i * o * d), S = m + l * (i * n * b + r * o * v), C = y + l * (r * n * b - i * o * v);
        return s[g] = [_, x, S, C, m, y], s[g]
    }
    ...
    function r(t, e, i, r, n, s, h, c) {
        ...
        if (o[l])return o[l];
        var u, f, g, d, p, v, b, m, y = Math.sqrt, _ = Math.min, x = Math.max, S = Math.abs, C = [], w = [[], []];
        f = 6 * t - 12 * i + 6 * n, u = -3 * t + 9 * i - 9 * n + 3 * h, g = 3 * i - 3 * t;
        for (var O = 0; 2 > O; ++O)if (O > 0 && (f = 6 * e - 12 * r + 6 * s, u = -3 * e + 9 * r - 9 * s + 3 * c, g = 3 * r - 3 * e), S(u) < 1e-12) {
            if (S(f) < 1e-12)continue;
            d = -g / f, d > 0 && 1 > d && C.push(d)
        } else b = f * f - 4 * g * u, 0 > b || (m = y(b), p = (-f + m) / (2 * u), p > 0 && 1 > p && C.push(p), v = (-f - m) / (2 * u), v > 0 && 1 > v && C.push(v));
        for (var T, k, j, A = C.length, P = A; A--;)d = C[A], j = 1 - d, T = j * j * j * t + 3 * j * j * d * i + 3 * j * d * d * n + d * d * d * h, w[0][A] = T, k = j * j * j * e + 3 * j * j * d * r + 3 * j * d * d * s + d * d * d * c, w[1][A] = k;
        w[0][P] = t, w[1][P] = e, w[0][P + 1] = h, w[1][P + 1] = c;
        var M = [{x: _.apply(null, w[0]), y: _.apply(null, w[1])}, {x: x.apply(null, w[0]), y: x.apply(null, w[1])}];
        return o[l] = M, M
    }

    var n = {}, s = {}, o = {}, a = Array.prototype.join;
    fabric.util.drawArc = function (e, i, r, n) {
        for (var s = n[0], o = n[1], a = n[2], h = n[3], c = n[4], l = n[5], u = n[6], f = [[], [], [], []], g = t(l - i, u - r, s, o, h, c, a), d = 0, p = g.length; p > d; d++)f[d][0] = g[d][0] + i, f[d][1] = g[d][1] + r, f[d][2] = g[d][2] + i, f[d][3] = g[d][3] + r, f[d][4] = g[d][4] + i, f[d][5] = g[d][5] + r, e.bezierCurveTo.apply(e, f[d])
    }, fabric.util.getBoundsOfArc = function (e, i, n, s, o, a, h, c, l) {
        for (var u = 0, f = 0, g = [], d = [], p = t(c - e, l - i, n, s, a, h, o), v = [[], []], b = 0, m = p.length; m > b; b++)g = r(u, f, p[b][0], p[b][1], p[b][2], p[b][3], p[b][4], p[b][5]), v[0].x = g[0].x + e, v[0].y = g[0].y + i, v[1].x = g[1].x + e, v[1].y = g[1].y + i, d.push(v[0]), d.push(v[1]), u = p[b][4], f = p[b][5];
        return d
    ...
    var l, u, f = t(fabric.document.documentElement, "addEventListener", "removeEventListener") && t(fabric.window, "addEventListener", "removeEventListener"), g = t(fabric.document.documentElement, "attachEvent", "detachEvent") && t(fabric.window, "attachEvent", "detachEvent"), d = {}, p = {};
    f ? (l = function (t, e, i) {
        ...
        var n = c(t);
        a(n, t), d[n] || (d[n] = {}), d[n][i] || (d[n][i] = []);
        var s = e(n, r);
        d[n][i].push(s), t.attachEvent("on" + i, s.wrappedHandler)
    }, u = function (t, e, i) {
        var r, n = c(t);
        if (d[n] && d[n][e])for (var s = 0, o = d[n][e].length; o > s; s++)r = d[n][e][s], r && r.handler === i && (t.detachEvent("on" + e, r.wrappedHandler), d[n][e][s] = null)
    }) : (l = function (t, e, i) {
        var n = c(t);
        if (p[n] || (p[n] = {}), !p[n][e]) {
            p[n][e] = [];
    ...
    function t(t) {
        e(function (i) {
            ...
            t.onStart && t.onStart(), function g(i) {
                r = i || +new Date;
                var u = r > o ? s : r - n;
                return h() ? void(t.onComplete && t.onComplete()) : (a(c(u, l, f, s)), r > o ? void(t.onComplete && t.onComplete()) : void e(g))
            }(n)
        })
    }
    ...
    function r(t) {
        for (var e in k)if (t[e] && "undefined" != typeof t[k[e]] && 0 !== t[e].indexOf("url(")) {
    ...
    function u(t) {
        for (var e = t.getElementsByTagName("use"), i = 0; e.length && i < e.length;) {
            var r, n, s, o, a, h = e[i], c = h.getAttribute("xlink:href").substr(1), u = h.getAttribute("x") || 0, g = h.getAttribute("y") || 0, d = l(t, c).cloneNode(!0), p = (d.getAttribute("transform") || "") + " translate(" + u + ", " + g + ")", v = e.length;
            if (f(d), /^svg$/i.test(d.nodeName)) {
                var b = d.ownerDocument.createElement("g");
                for (s = 0, o = d.attributes, a = o.length; a > s; s++)n = o.item(s), b.setAttribute(n.nodeName, n.nodeValue);
                for (; null != d.firstChild;)b.appendChild(d.firstChild);
                d = b
            }
            for (s = 0, o = h.attributes, a = o.length; a > s; s++)n = o.item(s), "x" !== n.nodeName && "y" !== n.nodeName && "xlink:href" !== n.nodeName && ("transform" === n.nodeName ? p = n.nodeValue + " " + p : d.setAttribute(n.nodeName, n.nodeValue));
            d.setAttribute("transform", p), d.setAttribute("instantiated_by_use", "1"), d.removeAttribute("id"), r = h.parentNode, r.replaceChild(d, h), e.length === v && i++
        }
    }

    function f(t) {
        var e, i, r, n, s = t.getAttribute("viewBox"), o = 1, a = 1, h = 0, c = 0, l = t.getAttribute("width"), u = t.getAttribute("height"), f = t.getAttribute("x") || 0, g = t.getAttribute("y") || 0, d = t.getAttribute("preserveAspectRatio") || "", v = !s || !C.test(t.tagName) || !(s = s.match(j)), b = !l || !u || "100%" === l || "100%" === u, m = v && b, y = {}, x = "";
        if (y.width = 0, y.height = 0, y.toBeParsed = m, m)return y;
        if (v)return y.width = _(l), y.height = _(u), y;
        if (h = -parseFloat(s[1]), c = -parseFloat(s[2]), e = parseFloat(s[3]), i = parseFloat(s[4]), b ? (y.width = e, y.height = i) : (y.width = _(l), y.height = _(u), o = y.width / e, a = y.height / i), d = p.util.parsePreserveAspectRatioAttribute(d), "none" !== d.alignX && (a = o = o > a ? a : o), 1 === o && 1 === a && 0 === h && 0 === c && 0 === f && 0 === g)return y;
        if ((f || g) && (x = " translate(" + _(f) + " " + _(g) + ") "), r = x + " matrix(" + o + " 0 0 " + a + " " + h * o + " " + c * a + ") ", "svg" === t.tagName) {
    ...
    p.cssRules = {}, p.gradientDefs = {}, p.parseTransformAttribute = function () {
        ...
        var s = [1, 0, 0, 1, 0, 0], o = p.reNum, a = "(?:\\s+,?\\s*|,\\s*)", h = "(?:(skewX)\\s*\\(\\s*(" + o + ")\\s*\\))", c = "(?:(skewY)\\s*\\(\\s*(" + o + ")\\s*\\))", l = "(?:(rotate)\\s*\\(\\s*(" + o + ")(?:" + a + "(" + o + ")" + a + "(" + o + "))?\\s*\\))", u = "(?:(scale)\\s*\\(\\s*(" + o + ")(?:" + a + "(" + o + "))?\\s*\\))", f = "(?:(translate)\\s*\\(\\s*(" + o + ")(?:" + a + "(" + o + "))?\\s*\\))", g = "(?:(matrix)\\s*\\(\\s*(" + o + ")" + a + "(" + o + ")" + a + "(" + o + ")" + a + "(" + o + ")" + a + "(" + o + ")" + a + "(" + o + ")\\s*\\))", d = "(?:" + g + "|" + f + "|" + u + "|" + l + "|" + h + "|" + c + ")", v = "(?:" + d + "(?:" + a + d + ")*)", b = "^\\s*(?:" + v + "?)\\s*$", m = new RegExp(b), y = new RegExp(d, "g");
        return function (o) {
            var a = s.concat(), h = [];
            if (!o || o && !m.test(o))return a;
            o.replace(y, function (o) {
                var c = new RegExp(d).exec(o).filter(function (t) {
                    return "" !== t && null != t
    ...
    p.parseSVGDocument = function () {
        ...
        return function (e, i, r) {
            if (e) {
                ...
                if (!g || g && !g.length)return void(i && i([], {}));
                p.gradientDefs[s] = p.getGradientDefs(e), p.cssRules[s] = p.getCSSRules(e), p.parseElements(g, function (t) {
    ...
    v(p, {
        parseFontDeclaration: function (t, e) {
            ...
            var e, i, r, n, s = t.getElementsByTagName("linearGradient"), o = t.getElementsByTagName("radialGradient"), a = 0, h = [], c = {}, l = {};
    ...
    return i.Intersection ? void i.warn("fabric.Intersection is already defined") : (i.Intersection = e, i.Intersection.prototype = {
        ...
        var s = r.min(n), o = r.max(n), a = new i.Point(o.x, s.y), h = new i.Point(s.x, o.y), c = e.intersectLinePolygon(s, a, t), l = e.intersectLinePolygon(a, o, t), u = e.intersectLinePolygon(o, h, t), f = e.intersectLinePolygon(h, s, t), g = new e;
    ...
    return r.Color ? void r.warn("fabric.Color is already defined.") : (r.Color = e, r.Color.prototype = {
        ...
        if (t.match(e.reHex)) {
            var i = t.slice(t.indexOf("#") + 1), r = 3 === i.length, n = r ? i.charAt(0) + i.charAt(0) : i.substring(0, 2), s = r ? i.charAt(1) + i.charAt(1) : i.substring(2, 4), o = r ? i.charAt(2) + i.charAt(2) : i.substring(4, 6);
    ...
    fabric.Gradient = fabric.util.createClass({
        ...
        fromElement: function (n, s) {
            var o, a = n.getElementsByTagName("stop"), h = "linearGradient" === n.nodeName ? "linear" : "radial", c = n.getAttribute("gradientUnits") || "objectBoundingBox", l = n.getAttribute("gradientTransform"), u = [], f = {};
            "linear" === h ? f = e(n) : "radial" === h && (f = i(n));
            for (var g = a.length; g--;)u.push(t(a[g]));
            o = r(s, f, c);
            var d = new fabric.Gradient({type: h, coords: f, colorStops: u, offsetX: -s.left, offsetY: -s.top});
            return (l || "" !== o) && (d.gradientTransform = fabric.parseTransformAttribute((l || "") + o)), d
    ...
    repeat: "repeat", offsetX: 0, offsetY: 0, initialize: function (t) {
        ...
        var e = "function" == typeof this.source ? this.source() : this.source, i = e.width / t.getWidth(), r = e.height / t.getHeight(), n = this.offsetX / t.getWidth(), s = this.offsetY / t.getHeight(), o = "";
    ...
    return e.Shadow ? void e.warn("fabric.Shadow is already defined.") : (e.Shadow = e.util.createClass({
        ...
        _parseShadow: function (t) {
            var i = t.trim(), r = e.Shadow.reOffsetsAndBlur.exec(i) || [], n = i.replace(e.Shadow.reOffsetsAndBlur, "") || "rgb(0,0,0)";
            return {
                color: n.trim(),
    ...
    fabric.StaticCanvas = fabric.util.createClass({
        ...
        __serializeBgOverlay: function () {
            ...
            this.backgroundImage && (t.backgroundImage = this.backgroundImage.toObject()), this.overlayImage && (t.overlayImage = this.overlayImage.toObject()), t
        },
    ...
    var t = fabric.util.getPointer, e = fabric.util.degreesToRadians, i = fabric.util.radiansToDegrees, r = Math.atan2, n = Math.abs, s = .5;
    fabric.Canvas = fabric.util.createClass(fabric.StaticCanvas, {
        ...
        _normalizePointer: function (t, e) {
            var i, r = this.getActiveGroup(), n = e.x, s = e.y, o = r && "group" !== t.type && r.contains(t);
        ...
        isTargetTransparent: function (t, e, i) {
            var r = t.hasBorders, n = t.transparentCorners;
            t.hasBorders = t.transparentCorners = !1, t.render(this.contextCache), t._renderControls(this.contextCache), t.hasBorders = r, t.transparentCorners = n;
        ...
        _skewObject: function (t, e, i) {
            var r = this._currentTransform, n = r.target, s = n.get("lockSkewingX"), o = n.get("lockSkewingY");
            if (!(s && "x" === i || o && "y" === i)) {
                var a, h, c = n.getCenterPoint(), l = n.toLocalPoint(new fabric.Point(t, e), "center", "center")[i], u = n.toLocalPoint(new fabric.Point(r.lastX, r.lastY), "center", "center")[i], f = n._getTransformedDimensions();
                this._changeSkewTransformOrigin(l - u, r, i), a = n.toLocalPoint(new fabric.Point(t, e), r.originX, r.originY)[i], h = n.translateToOriginPoint(c, r.originX, r.originY), this._setObjectSkew(a, r, i, f), r.lastX = t, r.lastY = e, n.setPositionByOrigin(h, r.originX, r.originY)
            }
        },
        _setObjectSkew: function (t, e, i, r) {
            var n, s, o, a, h, c, l, u, f, g = e.target, d = e.skewSign;
            "x" === i ? (a = "y", h = "Y", c = "X", u = 0, f = g.skewY) : (a = "x", h = "X", c = "Y", u = g.skewX, f = 0), o = g._getTransformedDimensions(u, f), l = 2 * Math.abs(t) - o[i], 2 >= l ? n = 0 : (n = d * Math.atan(l / g["scale" + c] / (o[a] / g["scale" + h])), n = fabric.util.radiansToDegrees(n)), g.set("skew" + c, n), 0 !== g["skew" + h] && (s = g._getTransformedDimensions(), n = r[a] / s[a] * g["scale" + h], g.set("scale" + h, n))
        },
        _scaleObject: function (t, e, i) {
            ...
            if (!s || !o) {
                var h = n.translateToOriginPoint(n.getCenterPoint(), r.originX, r.originY), c = n.toLocalPoint(new fabric.Point(t, e), r.originX, r.originY), l = n._getTransformedDimensions();
                this._setLocalMouse(c, r), this._setObjectScale(c, r, s, o, i, a, l), n.setPositionByOrigin(h, r.originX, r.originY)
            }
        },
        _setObjectScale: function (t, e, i, r, n, s, o) {
            var a = e.target, h = !1, c = !1;
            e.newScaleX = t.x * a.scaleX / o.x, e.newScaleY = t.y * a.scaleY / o.y, s && e.newScaleX <= 0 && e.newScaleX < a.scaleX && (h = !0), s && e.newScaleY <= 0 && e.newScaleY < a.scaleY && (c = !0), "equally" !== n || i || r ? n ? "x" !== n || a.get("lockUniScaling") ? "y" !== n || a.get("lockUniScaling") || c || r || a.set("scaleY", e.newScaleY) : h || i || a.set("scaleX", e.newScaleX) : (h || i || a.set("scaleX", e.newScaleX), c || r || a.set("scaleY", e.newScaleY)) : h || c || this._scaleObjectEqually(t, a, e, o), h || c || this._flipObject(e, n)
        },
        _scaleObjectEqually: function (t, e, i, r) {
            var n = t.y + t.x, s = r.y * i.original.scaleY / e.scaleY + r.x * i.original.scaleX / e.scaleX;
        ...
        drawControls: function (t) {
            t.save(), t.setTransform.apply(t, [1, 0, 0, 1, 0, 0]);
            var e = this.getActiveGroup();
            e ? e._renderControls(t) : this._drawObjectsControls(t), t.restore()
        },
    ...
    fabric.util.object.extend(fabric.Canvas.prototype, {
        ...
        __onMouseDown: function (t) {
            ...
            if (e || fabric.isTouchSupported) {
                ...
                if (!this._currentTransform) {
                    ...
                    this._shouldClearSelection(t, i) ? this._clearSelection(t, i, r) : s && (this._handleGrouping(t, i), i = this.getActiveGroup()), i && i.selectable && (i.__corner || !s) && (this._beforeTransform(t, i), this._setupCurrentTransform(t, i)), n && this.renderAll(), this.fire("mouse:down", {
                        target: i,
                        e: t
        ...
        _performTransformAction: function (t, e, i) {
            var r = i.x, n = i.y, s = e.target, o = e.action;
            "rotate" === o ? (this._rotateObject(r, n), this._fire("rotating", s, t)) : "scale" === o ? (this._onScale(t, e, r, n), this._fire("scaling", s, t)) : "scaleX" === o ? (this._scaleObject(r, n, "x"), this._fire("scaling", s, t)) : "scaleY" === o ? (this._scaleObject(r, n, "y"), this._fire("scaling", s, t)) : "skewX" === o ? (this._skewObject(r, n, "x"), this._fire("skewing", s, t)) : "skewY" === o ? (this._skewObject(r, n, "y"), this._fire("skewing", s, t)) : (this._translateObject(r, n), this._fire("moving", s, t), this.setCursor(this.moveCursor))
        },
        ...
        _onScale: function (t, e, i, r) {
            !t.shiftKey && !this.uniScaleTransform || e.target.get("lockUniScaling") ? (e.reset || "scale" !== e.currentAction || this._resetCurrentTransform(), e.currentAction = "scaleEqually", this._scaleObject(i, r, "equally")) : (e.currentAction = "scale", this._scaleObject(i, r))
        },
        _setCursorFromEvent: function (t, e) {
            ...
            return r ? this._setCornerCursor(r, e, t) : this.setCursor(e.hoverCursor || this.hoverCursor), !0
        },
    ...
    toDataURL: function (t) {
        ...
        this.renderAll();
        var r = this.lowerCanvasEl, n = this.__getCroppedCanvas(r, i);
        "jpg" === t && (t = "jpeg");
        ...
        r > 1 && this.setWidth(o).setHeight(a), l.scale(r, r), i.left && (i.left *= r), i.top && (i.top *= r), i.width ? i.width *= r : 1 > r && (i.width = o), i.height ? i.height *= r : 1 > r && (i.height = a), c ? this._tempRemoveBordersControlsFromGroup(c) : h && this.deactivateAll && this.deactivateAll();
    ...
    fabric.util.object.extend(fabric.Object.prototype, {
        ...
        }, _calcDimensionsTransformMatrix: function (t, i) {
            var r = [1, 0, Math.tan(e(t)), 1, 0, 0], n = [1, Math.tan(e(i)), 0, 1, 0, 0], s = [this.scaleX, 0, 0, this.scaleY, 0, 0], o = fabric.util.multiplyTransformMatrices(s, r, !0);
    ...
    fabric.util.object.extend(fabric.Object.prototype, {
        _controlsVisibility: null, _findTargetCorner: function (t) {
            ...
            var i, r, n = this._getNonTransformedDimensions(), s = n.x / 2, o = n.y / 2, a = [{x: -s, y: -o}, {
                x: s,
                y: -o
            }, {x: -s, y: o}, {x: s, y: o}], h = this._calcDimensionsTransformMatrix(t, e);
            ...
            var e = this._calculateCurrentDimensions(), i = e.x, r = e.y;
            ...
            var e = this._calculateCurrentDimensions(), i = e.x, r = e.y, n = this.cornerSize / 2, s = -(i / 2) - n, o = -(r / 2) - n, a = this.transparentCorners ? "strokeRect" : "fillRect";
    ...
    var i = t.fabric || (t.fabric = {}), r = i.util.object.extend, n = {
        x1: 1,
        x2: 1,
        y1: 1,
        y2: 1
    ...
    return i.Line ? void i.warn("fabric.Line is already defined") : (i.Line = i.util.createClass(i.Object, {
        ...
        calcLinePoints: function () {
            var t = this.x1 <= this.x2 ? -1 : 1, e = this.y1 <= this.y2 ? -1 : 1, i = t * this.width * .5, r = e * this.height * .5, n = t * this.width * -.5, s = e * this.height * -.5;
    ...
    return e.Triangle ? void e.warn("fabric.Triangle is already defined") : (e.Triangle = e.util.createClass(e.Object, {
        ...
        toSVG: function (t) {
            var e = this._createBaseSVGMarkup(), i = this.width / 2, r = this.height / 2, n = [-i + " " + r, "0 " + -r, i + " " + r].join(",");
    ...
    return e.Path ? void e.warn("fabric.Path is already defined") : (e.Path = e.util.createClass(e.Object, {
        ...
        _render: function (t) {
            var e, i, r, n = null, s = 0, a = 0, h = 0, c = 0, l = 0, u = 0, f = -this.pathOffset.x, g = -this.pathOffset.y;
            this.group && "path-group" === this.group.type && (f = 0, g = 0), t.beginPath();
            for (var d = 0, p = this.path.length; p > d; ++d) {
                switch (e = this.path[d], e[0]) {
                    case"l":
        ...
        _parsePath: function () {
            for (var t, e, i, r, n, s = [], o = [], c = /([-+]?((\d+\.\d+)|((\d+)|(\.\d+)))(?:e[-+]?\d+)?)/gi, l = 0, u = this.path.length; u > l; l++) {
                ...
                var d = n[0], p = a[d.toLowerCase()], v = h[d] || d;
                if (n.length - 1 > p)for (var b = 1, m = n.length; m > b; b += p)s.push([d].concat(n.slice(b, b + p))), d = v; else s.push(n)
            }
            return s
        },
        _parseDimensions: function () {
            for (var t, n, s, o, a = [], h = [], c = null, l = 0, u = 0, f = 0, g = 0, d = 0, p = 0, v = 0, b = this.path.length; b > v; ++v) {
                switch (t = this.path[v], t[0]) {
                    ...
                    case"M":
                        ...
                        break;
                    case"c":
                        n = f + t[5], s = g + t[6], d = f + t[3], p = g + t[4], o = e.util.getBoundsOfCurve(f, g, f + t[1], g + t[2], d, p, n, s), f = n, g = s;
                        break;
                    case"C":
                        f = t[5], g = t[6], d = t[3], p = t[4], o = e.util.getBoundsOfCurve(f, g, t[1], t[2], d, p, f, g);
                        break;
                    case"s":
                        n = f + t[3], s = g + t[4], null === c[0].match(/[CcSs]/) ? (d = f, p = g) : (d = 2 * f - d, p = 2 * g - p), o = e.util.getBoundsOfCurve(f, g, d, p, f + t[1], g + t[2], n, s), d = f + t[1], p = g + t[2], f = n, g = s;
                        break;
                    case"S":
                        n = t[3], s = t[4], null === c[0].match(/[CcSs]/) ? (d = f, p = g) : (d = 2 * f - d, p = 2 * g - p), o = e.util.getBoundsOfCurve(f, g, d, p, t[1], t[2], n, s), f = n, g = s, d = t[1], p = t[2];
                        break;
                    case"q":
                        n = f + t[3], s = g + t[4], d = f + t[1], p = g + t[2], o = e.util.getBoundsOfCurve(f, g, d, p, d, p, n, s), f = n, g = s;
                        break;
                    case"Q":
                        d = t[1], p = t[2], o = e.util.getBoundsOfCurve(f, g, d, p, d, p, t[3], t[4]), f = t[3], g = t[4];
                        break;
                    case"t":
                        n = f + t[1], s = g + t[2], null === c[0].match(/[QqTt]/) ? (d = f, p = g) : (d = 2 * f - d, p = 2 * g - p), o = e.util.getBoundsOfCurve(f, g, d, p, d, p, n, s), f = n, g = s;
                        break;
                    case"T":
                        n = t[1], s = t[2], null === c[0].match(/[QqTt]/) ? (d = f, p = g) : (d = 2 * f - d, p = 2 * g - p), o = e.util.getBoundsOfCurve(f, g, d, p, d, p, n, s), f = n, g = s;
                        break;
                    case"a":
            ...
            var m = i(a) || 0, y = i(h) || 0, _ = r(a) || 0, x = r(h) || 0, S = _ - m, C = x - y, w = {
                left: m,
                top: y,
                width: S,
                height: C
    ...
    if (!e.Group) {
        ...
        e.Group = e.util.createClass(e.Object, e.Collection, {
            ...
            _moveFlippedObject: function (t) {
                ...
                return t.set({originX: e, originY: i, left: n.x, top: n.y}), this
            },
    ...
    e.Image.filters.Convolute = e.util.createClass(e.Image.filters.BaseFilter, {
        ...
        applyTo: function (t) {
            for (var e = this.matrix, i = t.getContext("2d"), r = i.getImageData(0, 0, t.width, t.height), n = Math.round(Math.sqrt(e.length)), s = Math.floor(n / 2), o = r.data, a = r.width, h = r.height, c = a, l = h, u = this._createImageData(c, l), f = u.data, g = this.opaque ? 1 : 0, d = 0; l > d; d++)for (var p = 0; c > p; p++) {
                for (var v = d, b = p, m = 4 * (d * c + p), y = 0, _ = 0, x = 0, S = 0, C = 0; n > C; C++)for (var w = 0; n > w; w++) {
                    var O = v + C - s, T = b + w - s;
                    if (!(0 > O || O > h || 0 > T || T > a)) {
                        var k = 4 * (O * a + T), j = e[C * n + w];
                        y += o[k] * j, _ += o[k + 1] * j, x += o[k + 2] * j, S += o[k + 3] * j
                    }
                }
                f[m] = y, f[m + 1] = _, f[m + 2] = x, f[m + 3] = S + g * (255 - S)
            }
    ...
    e.Image.filters.Pixelate = e.util.createClass(e.Image.filters.BaseFilter, {
        ...
        applyTo: function (t) {
            ...
            for (i = 0; u > i; i += this.blocksize)for (r = 0; f > r; r += this.blocksize) {
                ...
                for (var g = i, d = i + this.blocksize; d > g; g++)for (var p = r, v = r + this.blocksize; v > p; p++)e = 4 * g * f + 4 * p, l[e] = n, l[e + 1] = s, l[e + 2] = o, l[e + 3] = a
            }
    ...
    e.Image.filters.Tint = e.util.createClass(e.Image.filters.BaseFilter, {
        type: "Tint", initialize: function (t) {
            ...
            var i, r, n, s, o, a, h, c, l, u = t.getContext("2d"), f = u.getImageData(0, 0, t.width, t.height), g = f.data, d = g.length;
            for (l = new e.Color(this.color).getSource(), r = l[0] * this.opacity, n = l[1] * this.opacity, s = l[2] * this.opacity, c = 1 - this.opacity, i = 0; d > i; i += 4)o = g[i], a = g[i + 1], h = g[i + 2], g[i] = r + o * c, g[i + 1] = n + a * c, g[i + 2] = s + h * c;
    ...
    e.Image.filters.Blend = e.util.createClass({
        type: "Blend", initialize: function (t) {
            ...
            var i, r, n, s, o, a, h, c, l, u, f = t.getContext("2d"), g = f.getImageData(0, 0, t.width, t.height), d = g.data, p = !1;
            if (this.image) {
                p = !0;
            ...
            for (var y = 0, _ = d.length; _ > y; y += 4)switch (s = d[y], o = d[y + 1], a = d[y + 2], p && (i = u[y] * this.alpha, r = u[y + 1] * this.alpha, n = u[y + 2] * this.alpha), this.mode) {
                case"multiply":
                    d[y] = s * i / 255, d[y + 1] = o * r / 255, d[y + 2] = a * n / 255;
                    break;
                case"screen":
                    d[y] = 1 - (1 - s) * (1 - i), d[y + 1] = 1 - (1 - o) * (1 - r), d[y + 2] = 1 - (1 - a) * (1 - n);
                    break;
                case"add":
                    d[y] = Math.min(255, s + i), d[y + 1] = Math.min(255, o + r), d[y + 2] = Math.min(255, a + n);
                    break;
                case"diff":
                case"difference":
                    d[y] = Math.abs(s - i), d[y + 1] = Math.abs(o - r), d[y + 2] = Math.abs(a - n);
                    break;
                case"subtract":
                    h = s - i, c = o - r, l = a - n, d[y] = 0 > h ? 0 : h, d[y + 1] = 0 > c ? 0 : c, d[y + 2] = 0 > l ? 0 : l;
                    break;
                case"darken":
                    d[y] = Math.min(s, i), d[y + 1] = Math.min(o, r), d[y + 2] = Math.min(a, n);
                    break;
                case"lighten":
                    d[y] = Math.max(s, i), d[y + 1] = Math.max(o, r), d[y + 2] = Math.max(a, n)
            }
    ...
    "use strict";
    var e = t.fabric || (t.fabric = {}), i = Math.pow, r = Math.floor, n = Math.sqrt, s = Math.abs, o = Math.max, a = Math.round, h = Math.sin, c = Math.ceil;
    e.Image.filters.Resize = e.util.createClass(e.Image.filters.BaseFilter, {
        ...
        sliceByTwo: function (t, i, n, s, a) {
            var h, c = t.getContext("2d"), l = .5, u = .5, f = 1, g = 1, d = !1, p = !1, v = i, b = n, m = e.util.createCanvasElement(), y = m.getContext("2d");
            for (s = r(s), a = r(a), m.width = o(s, i), m.height = o(a, n), s > i && (l = 2, f = -1), a > n && (u = 2, g = -1), h = c.getImageData(0, 0, i, n), t.width = o(s, i), t.height = o(a, n), c.putImageData(h, 0, 0); !d || !p;)i = v, n = b, s * f < r(v * l * f) ? v = r(v * l) : (v = s, d = !0), a * g < r(b * u * g) ? b = r(b * u) : (b = a, p = !0), h = c.getImageData(0, 0, i, n), y.putImageData(h, 0, 0), c.clearRect(0, 0, v, b), c.drawImage(m, 0, 0, i, n, 0, 0, v, b);
        ...
        lanczosResize: function (t, e, o, a, l) {
            ...
            function f(t) {
                var h, c, u, g, d, j, A, P, M, L, D;
                for (T.x = (t + .5) * y, k.x = r(T.x), h = 0; l > h; h++) {
                    for (T.y = (h + .5) * _, k.y = r(T.y), d = 0, j = 0, A = 0, P = 0, M = 0, c = k.x - C; c <= k.x + C; c++)if (!(0 > c || c >= e)) {
                        L = r(1e3 * s(c - T.x)), O[L] || (O[L] = {});
                        for (var I = k.y - w; I <= k.y + w; I++)0 > I || I >= o || (D = r(1e3 * s(I - T.y)), O[L][D] || (O[L][D] = m(n(i(L * x, 2) + i(D * S, 2)) / 1e3)), u = O[L][D], u > 0 && (g = 4 * (I * e + c), d += u, j += u * v[g], A += u * v[g + 1], P += u * v[g + 2], M += u * v[g + 3]))
                    }
                    g = 4 * (h * a + t), b[g] = j / d, b[g + 1] = A / d, b[g + 2] = P / d, b[g + 3] = M / d
                }
                return ++t < a ? f(t) : p
            }

            var g = t.getContext("2d"), d = g.getImageData(0, 0, e, o), p = g.getImageData(0, 0, a, l), v = d.data, b = p.data, m = u(this.lanczosLobes), y = this.rcpScaleX, _ = this.rcpScaleY, x = 2 / this.rcpScaleX, S = 2 / this.rcpScaleY, C = c(y * this.lanczosLobes / 2), w = c(_ * this.lanczosLobes / 2), O = {}, T = {}, k = {};
            return f(0)
        },
        bilinearFiltering: function (t, e, i, n, s) {
            var o, a, h, c, l, u, f, g, d, p, v, b, m, y = 0, _ = this.rcpScaleX, x = this.rcpScaleY, S = t.getContext("2d"), C = 4 * (e - 1), w = S.getImageData(0, 0, e, i), O = w.data, T = S.getImageData(0, 0, n, s), k = T.data;
            for (f = 0; s > f; f++)for (g = 0; n > g; g++)for (l = r(_ * g), u = r(x * f), d = _ * g - l, p = x * f - u, m = 4 * (u * e + l), v = 0; 4 > v; v++)o = O[m + v], a = O[m + 4 + v], h = O[m + C + v], c = O[m + C + 4 + v], b = o * (1 - d) * (1 - p) + a * d * (1 - p) + h * p * (1 - d) + c * d * p, k[y++] = b;
            return T
        },
        hermiteFastResize: function (t, e, i, o, a) {
            for (var h = this.rcpScaleX, l = this.rcpScaleY, u = c(h / 2), f = c(l / 2), g = t.getContext("2d"), d = g.getImageData(0, 0, e, i), p = d.data, v = g.getImageData(0, 0, o, a), b = v.data, m = 0; a > m; m++)for (var y = 0; o > y; y++) {
                for (var _ = 4 * (y + m * o), x = 0, S = 0, C = 0, w = 0, O = 0, T = 0, k = 0, j = (m + .5) * l, A = r(m * l); (m + 1) * l > A; A++)for (var P = s(j - (A + .5)) / f, M = (y + .5) * h, L = P * P, D = r(y * h); (y + 1) * h > D; D++) {
                    var I = s(M - (D + .5)) / u, E = n(L + I * I);
                    E > 1 && -1 > E || (x = 2 * E * E * E - 3 * E * E + 1, x > 0 && (I = 4 * (D + A * e), k += x * p[I + 3], C += x, p[I + 3] < 255 && (x = x * p[I + 3] / 250), w += x * p[I], O += x * p[I + 1], T += x * p[I + 2], S += x))
                }
    ...
    "use strict";
    var e = t.fabric || (t.fabric = {}), i = e.util.object.extend, r = e.util.object.clone, n = e.util.toFixed, s = e.StaticCanvas.supports("setLineDash"), o = e.Object.NUM_FRACTION_DIGITS;
    ...
    a.push("fontFamily", "fontWeight", "fontSize", "text", "textDecoration", "textAlign", "fontStyle", "lineHeight", "textBackgroundColor"), e.Text = e.util.createClass(e.Object, {
        ...
        _renderTextLine: function (t, e, i, r, n, s) {
            ...
            for (var a, h = i.split(/\s+/), c = this._getWidthOfWords(e, i, s), l = this.width - c, u = h.length - 1, f = u > 0 ? l / u : 0, g = 0, d = 0, p = 0, v = h.length; v > p; p++) {
                for (; " " === i[d] && d < i.length;)d++;
                a = h[p], this._renderChars(t, e, a, r + g, n, s, d), g += e.measureText(a).width + f, d += a.length
            }
        },
        ...
        _renderTextFill: function (t) {
            if (this.fill || this._skipFillStrokeCheck)for (var e = 0, i = 0, r = this._textLines.length; r > i; i++) {
        ...
        _renderTextLinesBackground: function (t) {
            if (this.textBackgroundColor) {
                var e, i, r = 0, n = this._getHeightOfLine();
        ...
        toSVG: function (t) {
            var e = this._createBaseSVGMarkup(), i = this._getSVGLeftTopOffsets(this.ctx), r = this._getSVGTextAndBg(i.textTop, i.textLeft);
        ...
        var n = t.textContent.replace(/^\s+|\s+$|\n+/g, "").replace(/\s+/g, " "), s = new e.Text(n, i), o = 0;
    ...
    fabric.IText = fabric.util.createClass(fabric.Text, fabric.Observable, {
        ...
        renderSelection: function (t, e, i) {
            ...
            for (var r = this.get2DCursorLocation(this.selectionStart), n = this.get2DCursorLocation(this.selectionEnd), s = r.lineIndex, o = n.lineIndex, a = s; o >= a; a++) {
                ...
                if (a === s)for (var f = 0, g = u.length; g > f; f++)f >= r.charIndex && (a !== o || f < n.charIndex) && (l += this._getWidthOfChar(i, u[f], a, f)), f < r.charIndex && (h += this._getWidthOfChar(i, u[f], a, f)); else if (a > s && o > a)l += this._getLineWidth(i, a) || 5; else if (a === o)for (var d = 0, p = n.charIndex; p > d; d++)l += this._getWidthOfChar(i, u[d], a, d);
        ...
        _renderChars: function (t, e, i, r, n, s, o) {
            ...
            for (var f = o, g = i.length + o; g >= f; f++)a = a || this.getCurrentCharStyle(s, f), h = this.getCurrentCharStyle(s, f + 1), (this._hasStyleChanged(a, h) || f === g) && (this._renderChar(t, e, s, f - 1, u, r, n, c), u = "", a = h), u += i[f - o];
            e.restore()
        },
            ...
            if (this.textBackgroundColor || this.styles) {
                ...
                for (var e = 0, i = 0, r = this._textLines.length; r > i; i++) {
                    ...
                    if ("" !== this._textLines[i]) {
                        var s = this._getLineWidth(t, i), o = this._getLineLeftOffset(s);
                        if (this.textBackgroundColor && (t.fillStyle = this.textBackgroundColor, t.fillRect(this._getLeftOffset() + o, this._getTopOffset() + e, s, n / this.lineHeight)), this._getLineStyle(i))for (var a = 0, h = this._textLines[i].length; h > a; a++) {
        ...
        _applyCharStylesGetWidth: function (e, i, r, n, s) {
            var o, a = this._getStyleDeclaration(r, n), h = s || t(a);
            ...
            return e.fillStyle = l.toLive ? l.toLive(e, this) : l, h.stroke && (e.strokeStyle = h.stroke && h.stroke.toLive ? h.stroke.toLive(e, this) : h.stroke), e.lineWidth = h.strokeWidth || this.strokeWidth, e.font = this._getFontDeclaration.call(h), this._setShadow.call(h, e), this.caching && this._charWidthsCache[c] || (o = e.measureText(i).width, this.caching && (this._charWidthsCache[c] = o)), this._charWidthsCache[c]
        },
        ...
        _getWidthOfSpace: function (t, e) {
            ...
            var i = this._textLines[e], r = this._getWidthOfWords(t, i, e), n = this.width - r, s = i.length - i.replace(this._reSpacesAndTabs, "").length, o = n / s;
    ...
    onInput: function (t) {
        if (this.isEditing) {
            var e = this.selectionStart || 0, i = this.selectionEnd || 0, r = this.text.length, n = this.hiddenTextarea.value.length, s = n - r + i - e, o = this.hiddenTextarea.value.slice(e, e + s);
    ...
    getDownCursorOffset: function (t, e) {
        var i, r, n = e ? this.selectionEnd : this.selectionStart, s = this.get2DCursorLocation(n), o = s.lineIndex, a = this._textLines[o].slice(0, s.charIndex), h = this._textLines[o].slice(s.charIndex), c = this._textLines[o + 1] || "";
        ...
        for (var u = r, f = 0, g = a.length; g > f; f++)i = a[f], u += this._getWidthOfChar(this.ctx, i, o, f);
        var d = this._getIndexOnNextLine(s, c, u);
        return h.length + 1 + d
    },
    _getIndexOnNextLine: function (t, e, i) {
        for (var r, n = t.lineIndex + 1, s = this._getLineWidth(this.ctx, n), o = this._getLineLeftOffset(s), a = o, h = 0, c = 0, l = e.length; l > c; c++) {
            ...
            if (a += f, a > i) {
                r = !0;
                var g = a - f, d = a, p = Math.abs(g - i), v = Math.abs(d - i);
                h = p > v ? c + 1 : c;
                break
            }
        }
    ...
    getUpCursorOffset: function (t, e) {
        ...
        var g = this._getIndexOnPrevLine(r, a, l);
        return a.length - g + o.length
    },
    ...
    fabric.util.object.extend(fabric.IText.prototype, {
        _setSVGTextLineText: function (t, e, i, r, n, s) {
            ...
            for (var s = this._textLines[t], o = 0, a = this._getLineLeftOffset(this._getLineWidth(this.ctx, t)) - this.width / 2, h = this._getSVGLineTopOffset(t), c = this._getHeightOfLine(this.ctx, t), l = 0, u = s.length; u > l; l++) {
                ...
                var g = this._getWidthOfChar(this.ctx, s[l], t, l);
                f.textBackgroundColor && n.push(this._createTextCharBg(f, a, h.lineTop, c, g, o)), o += g
            }
    ...
    e.Textbox = e.util.createClass(e.IText, e.Observable, {
        ...
        _wrapLine: function (t, e, i) {
            for (var r = 0, n = [], s = "", o = e.split(" "), a = "", h = 0, c = " ", l = 0, u = 0, f = 0, g = 0; g < o.length; g++)a = o[g], l = this._measureText(t, a, i, h), h += a.length, r += u + l, r >= this.width && "" !== s && (n.push(s), s = "", r = l), ("" !== s || 1 === g) && (s += c), s += a, u = this._measureText(t, c, i, h), h++, l > f && (f = l);
